...
void CDebugProc::Draw(void)
{
	...
	RECT rect2 = { 0,450,SCREEN_WIDTH,SCREEN_HEIGHT };
	RECT rect3 = { 0,600,SCREEN_WIDTH,SCREEN_HEIGHT };
	RECT rect4 = { 0,750,SCREEN_WIDTH,SCREEN_HEIGHT };
	...
	m_pFont->DrawText(NULL, m_aStr[2], -1, &rect2, DT_LEFT, D3DCOLOR_ARGB(0xff, 255, 255, 15));
	m_pFont->DrawText(NULL, m_aStr[3], -1, &rect3, DT_LEFT, D3DCOLOR_ARGB(0xff, 255, 255, 15));
